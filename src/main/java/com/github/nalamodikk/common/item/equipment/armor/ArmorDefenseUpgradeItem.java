...
public class ArmorDefenseUpgradeItem extends Item implements IModUpgrade {

    public static final int[] BONUS_PER_MK = {1, 2, 3, 4};
    public static final int COLOR = 0xFF8888FF;

    private final int mk;

    public ArmorDefenseUpgradeItem(int mk, Properties properties) {
        super(properties);
        this.mk = mk;
    }
    ...
    public Component getUpgradeDisplayName() {
        return Component.translatable("item.koniava.armor_upgrade_defense");
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext ctx, List<Component> lines, TooltipFlag flag) {
        ...
        lines.add(Component.translatable("tooltip.koniava.wand_upgrade.type",
                Component.translatable("item.koniava.armor_upgrade_defense")));
        lines.add(Component.translatable("tooltip.koniava.armor_upgrade.effect.defense", getBonus()));
