...
public class LeggingsUpgradeItem extends Item implements IModUpgrade {

    private final LeggingsUpgradeBehavior behavior;
    private final int mk;

    public LeggingsUpgradeItem(LeggingsUpgradeBehavior behavior, int mk, Properties properties) {
        super(properties);
        this.behavior = behavior;
        this.mk = mk;
    }

    public LeggingsUpgradeBehavior getBehavior() { return behavior; }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext ctx, List<Component> lines, TooltipFlag flag) {
        ...
        lines.add(Component.translatable("tooltip.koniava.upgrade.compatible",
                Component.translatable("item.koniava.mana_alloy_leggings").withStyle(ChatFormatting.YELLOW)
