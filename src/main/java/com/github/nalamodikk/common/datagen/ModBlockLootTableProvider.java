...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected ModBlockLootTableProvider(HolderLookup.Provider registries) {
        ...
        addExcludedBlock(ModBlocks.MANA_CHARGER.get()); // 魔力充能台：onRemove 手動掉落並保存魔力 NBT
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.SHIP_CORE.get());            // 飛船核心
        dropSelf(ModBlocks.SHIP_ASSEMBLY_PAD.get());    // 飛船組裝台
        dropSelf(ModBlocks.SHIP_ASSEMBLY_BASE.get());   // 飛船組裝底座
        dropSelf(ModBlocks.SHIP_ASSEMBLY_GANTRY.get()); // 飛船組裝架
        ...
        this.add(ModBlocks.ALTAR_PILLAR.get(), createSingleItemTable(ModBlocks.MANA_BLOCK.get()));
        // resonance_ring 是內部佔位方塊，挖掉還給玩家 mana_block
        this.add(ModBlocks.RESONANCE_RING.get(), createSingleItemTable(ModBlocks.MANA_BLOCK.get()));
