 ...
 * 这是一个参考示例，展示两种使用方式。
 */
public class OreGrinderScreenExample extends AutoSizedModularScreen<OreGrinderMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(KoniavacraftMod.MOD_ID, "textures/gui/ore_grinder_gui.png");

    // ============================================
    // 使用方式 1: 自动检测 PNG 尺寸（推荐）
    // ============================================
    public OreGrinderScreenExample(OreGrinderMenu menu, Inventory inv, Component title) {
        // ✨ PNG 是多大，GUI 就是多大（自动检测）
