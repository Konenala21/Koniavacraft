...
Five spaceship blocks got new hand-drawn 3D models and textures: the ship core, the assembly pad, the assembly gantry, the mana fuel tank, and the ship seat. The fuel tank is now a glass-windowed tower whose mana shows as a cyan liquid level rising and falling with how much fuel it holds, so you can read a tank at a glance.
五個飛船方塊換上手繪的 3D 模型和貼圖:飛船核心、組裝台、組裝支架、魔力燃料槽、飛船座椅。燃料槽現在是有玻璃窗的塔狀槽,魔力顯示成青色液面,會隨儲量升降,一眼就看得出哪槽滿哪槽空。
